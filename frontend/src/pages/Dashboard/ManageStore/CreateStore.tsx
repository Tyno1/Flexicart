import React, { useContext, useState, useRef, CSSProperties } from "react";
...
const CreateStore: React.FC = () => {
  ...
  const { createStore, loading } = useContext(StoreContext);
    ...
    <div className="container w-[100vw]  lg:w-full h-full bg-white rounded-2xl">
      ...
      >
        ...
        <div className="Shop-Description flex flex-col gap-2 w-full">
          ...
          <textarea
            required
            className="w-full p-4 border rounded-lg font-normal bg-[#F1F4F9] border-[#D8D8D8] whitespace-nowrap"
